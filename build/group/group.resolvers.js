...
var resolvers = {
    ...
    Group: {
        ...
        //     })
        //     .messages(),
        unreadMessage: function (_a, _, _b) {
            var id = _a.id;
        ...
        inviter: function (_a, _, _b) {
            var id = _a.id;
            var client = _b.client, loggedInUser = _b.loggedInUser;
            return __awaiter(void 0, void 0, void 0, function () {
                var inviterInfo, inviter;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, client.group
                                .findFirst({
                                where: {
                                    id: id
                                }
                        ...
                        case 1:
                            inviterInfo = _c.sent();
                            return [4 /*yield*/, client.inviter.findFirst({
                                    where: {
                                        id: inviterInfo.id
                                    },
                                    include: {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            member = _c.sent();
                            return [2 /*return*/, member.members.length];
                    }
                });
            });
        }
