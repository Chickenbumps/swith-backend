...
var resolvers = {
    Query: {
        isMe: users_utils_1.securedResolver(function (_, __, _a) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            meDate = me.updatedAt.slice(5, 10);
                            if (!(meDate !== moment_1["default"]().format("MM-DD").toString())) return [3 /*break*/, 3];
